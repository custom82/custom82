...
inherit git-r3 distutils-r1 cargo

DESCRIPTION="Embedding database for LLM apps"
HOMEPAGE="https://github.com/custom82/chroma"
...
EGIT_REPO_URI="https://github.com/custom82/chroma.git"
EGIT_BRANCH="main"
...
src_unpack() {
	git-r3_src_unpack
 	cargo_src_unpack
	unpack "${GCLOUD_RUST_P}.tar.gz"
	unpack "${HNSWLIB_P}.tar.gz"
}
