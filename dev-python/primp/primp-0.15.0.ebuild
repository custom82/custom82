...
CRATES="
	...
	cxx-1.0.152
	cxx-build-1.0.152
	cxxbridge-flags-1.0.152
	cxxbridge-macro-1.0.152
	deranged-0.4.0
	digest-0.10.7
	displaydoc-0.2.5
...
DESCRIPTION="HTTP client that can impersonate web browsers (TLS/JA3/JA4/HTTP2 fingerprints)"
HOMEPAGE="https://github.com/deedy5/primp"
SRC_URI="
	https://github.com/deedy5/primp/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	$(cargo_crate_uris)
"
